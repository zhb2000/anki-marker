...
/** 是否为 macOS（仅 macOS 有辅助功能权限卡片；Windows/Linux 的取词无需授权） */
...
<template>
    <div class="settings-page">
        ...
        <div class="card-list">
            ...
            <!-- 辅助功能权限为 macOS 专属概念（Windows UIA / Linux AT-SPI 均无需授权） -->
            <FluentSettingCard v-if="isMacOS && state.globalShortcut.length > 0" header="辅助功能权限"
