 ...
 * 内边距 24px；标题 20px SemiBold；命令区按钮等宽通栏、间距 8px、高 32px，
...
/* 底部命令区：ContentDialog 规格——按钮等宽通栏、间距 8px（ContentDialogButtonSpacing）、
   24px 内边距 */
.dialog-commands {
    display: grid;
    flex-shrink: 0;
...
/* 命令按钮复用 FluentButton（WinUI Button 样式），此处对齐 ContentDialog 规格：
   通栏宽度、高 32px（ContentDialogButtonHeight）、字号 14px（ControlContentThemeFontSize） */
.command-button {
